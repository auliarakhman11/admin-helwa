                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-5 ms-auto">
                                            <div>
                                                <img src="{{ asset('template') }}/images/widget-img.png" alt=""
                                                    class="img-fluid">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div dir="ltr" class="ms-2">
                                            <input data-plugin="knob" data-width="56" data-height="56" data-linecap=round
                                                data-displayInput=false data-fgColor="#3051d3" value="56"
                                                data-skin="tron" data-angleOffset="56" data-readOnly=true
                                                data-thickness=".17" />
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="d-flex">
                                        <div class="media-body flex-grow-1">
                                            ...
                                            <h5 class="mb-0"> + 12 % <span class="font-size-14 text-muted ms-1">From
                                                    previous
                                                    period</span></h5>
                                        </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="text-center mt-3">
                                        <div class="row">
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted"><i class="mdi mdi-circle text-primary me-1"></i>
                                                        Facebook
                                                    </p>
                                                    <h5>$ 1,625</h5>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div>
                                                    <p class="text-muted"><i class="mdi mdi-circle text-warning me-1"></i>
                                                        Twitter
                                                    </p>
                                                    <h5>$ 1,504</h5>
                                                </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <table class="table table-centered table-hover mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>26 Jan</td>
                                                    <td>
                                                        <div class="badge bg-primary-subtle text-primary">Confirm
                                                        </div>
                                                    </td>
                                                    <td>$124</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>21 Jan</td>
                                                    <td>
                                                        <div class="badge bg-warning-subtle text-warning">Pending
                                                        </div>
                                                    </td>
                                                    <td>$112</td>
                                                    <td>
                                    ...
                                    <div class="mt-4">
                                        <ul class="pagination pagination-rounded justify-content-center mb-0">
                                            ...
                                            <li class="page-item"><a class="page-link me-2" href="#">1</a>
                                            </li>
                                            <li class="page-item active"><a class="page-link me-2" href="#">2</a>
                                            </li>
                                            <li class="page-item"><a class="page-link me-2" href="#">3</a>
                                            </li>
                                            <li class="page-item"><a class="page-link me-2" href="#">4</a>
                                            </li>
                                            <li class="page-item">
                                                    ...
                                                    <td>
                                                        <div dir="ltr" class="ms-2">
                                                            <input data-plugin="knob" data-width="36" data-height="36"
                                                                ...
                                                                data-angleOffset="36" data-readOnly=true
                                                                data-thickness=".2" />
                                                        </div>
                                                    </td>
                                                </tr>
