        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">Member</h4>
                                        ...
                                        @foreach ($member as $d)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form class="d-inline-block" action="{{ route('dropMember') }}"
                                                        method="post">
                                                        @csrf
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                <label>Nama</label>
                                <input type="text" name="nm_member" class="form-control" placeholder="Masukan nama"
                                    required>
                            </div>
                            ...
                            <div class="col-12 col-md-6">
                                <label>Diskon</label>
                                <input type="number" name="diskon" class="form-control" placeholder="Masukan diskon"
                                    required>
                            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <label>Nama</label>
                                    <input type="text" name="nm_member" value="{{ $k->nm_member }}"
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <input type="number" name="no_tlp" value="{{ $k->no_tlp }}"
                                        class="form-control" placeholder="Masukan nomor" required>
                                </div>

                                <div class="col-12 col-md-6">
                                    <label>Diskon</label>
                                    <input type="number" name="diskon" value="{{ $k->diskon }}"
                                        class="form-control" placeholder="Masukan diskon" required>
                                </div>
